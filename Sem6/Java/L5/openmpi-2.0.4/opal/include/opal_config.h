...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing  -D__EXTENSIONS__' CPPFLAGS='  -I/home/dev/Downloads/openmpi-2.0.4/opal/mca/hwloc/hwloc1112/hwloc/include -I/home/dev/Downloads/openmpi-2.0.4/opal/mca/event/libevent2022/libevent -I/home/dev/Downloads/openmpi-2.0.4/opal/mca/event/libevent2022/libevent/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/home/dev/opt/usr/local --disable-aio --disable-weak-symbols --enable-strict"
...
#define OPAL_PACKAGE_STRING "Open MPI dev@Aspire5 Distribution"
...
#define WRAPPER_EXTRA_LIBS "-lm -lnuma "
